...
namespace Breakaleg.Core.Compiler
{
    public class JSCompiler
    {
        ...
        private static readonly string[] ReservedWords = { "break", "case", "catch", "continue", "debugger", "default", "delete", "do", 
        ...
        private static readonly List<Type> OperatorPrecedence = new List<Type>(
        new[]{
        ...
        private static readonly string[] BinaryOpStrings = {
                ">>>=",
                "===", ">>>", ">>=", "<<=", "!==",
                ">=", "<=", "==", "!=", "<<", ">>", "&&", "||", "^=", "&=", "|=", "/=", "*=", "+=", "-=", "%=",
                ">", "<", "=", "+", "-", "*", "/", "%", "&", "|", "^" };
        private static readonly Type[] BinaryOpTypes = { 
